...
describe('Testes da API Tarefas', () => {
    ...
    test('GET/tarefas deve retornar 200', async() => {
        ...
        expect(Array.isArray (response.body)).toBeTruthy();     // pode ser tb "toBe(true)"
    });
    ...
    test('POST /tarefas deve retornar 201', async() => {
        ...
        expect(response.headers['content-type']).toMatch(/json/);   // devolvendo json
    ...
    test('GET/tarefas/id deve retorar 200', async() => {
